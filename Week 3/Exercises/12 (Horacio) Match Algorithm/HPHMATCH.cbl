      ...
      *                                                                         
       1200-ABRIR-ARCHS.                                                        
           ...
           EVALUATE TRUE                                                        
              WHEN FILE-A1-OK AND FILE-B2-OK AND FILE-S1-OK                     
                 CONTINUE                                                       
              WHEN OTHER                                                        
                 DISPLAY 'ERROR FILE STATUS A1...' WS-FS-A1                     
                 DISPLAY 'ERROR FILE STATUS B2...' WS-FS-B2                     
                 DISPLAY 'ERROR FILE STATUS S1...' WS-FS-S1                     
                 STOP RUN                                                       
           END-EVALUATE.                                                        
      *                                                                         
       1300-LEER-ARCH-A1.                                                       
      ...
      *                                                                         
       2100-ESCRIBIR-SALIDA.                                                    
           MOVE A1-DIGITO        TO SAL-DIGITO                                  
           MOVE A1-SECUENCIA     TO SAL-SECUENCIA                               
           MOVE A1-FOLIO         TO SAL-FOLIO                                   
           MOVE A1-RESTO         TO SAL-RESTO                                   
           WRITE REG-SAL                                                        
           EVALUATE TRUE                                                        
              WHEN FILE-S1-OK                                                   
      ...
      *                                                                         
       3100-CERRAR-ARCHS.                                                       
           ...
           END-EVALUATE.                                                        
      *                                                                         
       3200-DESPLEGAR-CIFRAS-CONTROL.                                           
           DISPLAY '*****************************************'                  
           DISPLAY '***  C I F R A S  D E   C O N T R O L ***'                  
           DISPLAY '***  REGS. LEIDOS A1.........' WS-LEIDOS-A1                 
           DISPLAY '***  REGS. LEIDOS B2.........' WS-LEIDOS-B2                 
